...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.fragment == variableId) {
            setFragment((com.relateddigital.shoppingdemo.main.MainActivity) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setFragment(@Nullable com.relateddigital.shoppingdemo.main.MainActivity Fragment) {
