...
public class FragmentRegisterBindingImpl extends FragmentRegisterBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.btn_register, 1);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.fragment == variableId) {
            setFragment((com.relateddigital.shoppingdemo.fragments.RegisterFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setFragment(@Nullable com.relateddigital.shoppingdemo.fragments.RegisterFragment Fragment) {
