...
public class FragmentMainBindingImpl extends FragmentMainBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.fragment == variableId) {
            setFragment((com.relateddigital.shoppingdemo.main.MainFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setFragment(@Nullable com.relateddigital.shoppingdemo.main.MainFragment Fragment) {
