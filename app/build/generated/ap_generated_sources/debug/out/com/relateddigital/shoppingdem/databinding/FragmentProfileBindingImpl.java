...
public class FragmentProfileBindingImpl extends FragmentProfileBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.btn_send_push, 2);
        sViewsWithIds.put(R.id.btn_logout, 3);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.fragment == variableId) {
            setFragment((com.relateddigital.shoppingdemo.fragments.ProfileFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setFragment(@Nullable com.relateddigital.shoppingdemo.fragments.ProfileFragment Fragment) {
