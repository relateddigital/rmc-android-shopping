...
public class FragmentBasketBindingImpl extends FragmentBasketBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_product_content, 5);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.fragment == variableId) {
            setFragment((com.melikeey.shoppingdemo.tabs.BasketFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setFragment(@Nullable com.melikeey.shoppingdemo.tabs.BasketFragment Fragment) {
