...
public class FragmentProfileBindingImpl extends FragmentProfileBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.btn_logout, 2);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.fragment == variableId) {
            setFragment((com.melikeey.shoppingdemo.fragments.ProfileFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setFragment(@Nullable com.melikeey.shoppingdemo.fragments.ProfileFragment Fragment) {
